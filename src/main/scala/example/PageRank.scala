...
object PageRank {
  def main(args: Array[String]) {
    ...
    //读入数据文件
    val articles: RDD[String] = sc.textFile("./src/main/scala/example/graphx-wiki-vertices.txt")
    val links: RDD[String] = sc.textFile("./src/main/scala/example/graphx-wiki-edges.txt")
